...
// Type: IToolS.IOServers.BandR.CpuParametersEditor
...
{
  public class CpuParametersEditor : UITypeEditor
  {
...
label_0:
      ...
      switch (num2 == num3 ? 1 : 0)
      {
        ...
        default:
          ...
          if (num1 == (short) 0)
            ;
          CpuParametersEditorDialog parametersEditorDialog = new CpuParametersEditorDialog(Convert.ToString(value));
